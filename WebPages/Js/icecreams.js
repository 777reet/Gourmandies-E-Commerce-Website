...
function addToCart(name, price, button) {
  ...
  toast.textContent = `${name} added to cart! 🍦`; // ice cream emoji instead of cookie
  ...
  // Store in cart (for later storage logic)
